<template>
  <section class="result-page success">
    ...
    <div class="result-card">
      ...
      <p class="result-kicker">Order received</p>
      ...
      <p class="result-description">
        Your order has been received. We will prepare your mochi fresh and
        process the order as soon as possible.
      </p>

      <div class="result-actions">
        <router-link to="/" class="primary-link">
          Back to Home
          <span>→</span>
        </router-link>

        <router-link to="/orders" class="secondary-link">
          View Orders
        </router-link>
      </div>
    </div>
