...
onMounted(async () => {
  try {
    const [statsRes, ordersRes, productsRes, reviewsRes] = await Promise.all([
      fetch('http://https://mochi-mevn.onrender.com/api/admin/stats', { credentials: 'include' }),
      fetch('http://https://mochi-mevn.onrender.com/api/admin/orders', { credentials: 'include' }),
      fetch('http://https://mochi-mevn.onrender.com/api/admin/products', { credentials: 'include' }),
      fetch('http://https://mochi-mevn.onrender.com/api/admin/reviews', { credentials: 'include' }),
    ])
