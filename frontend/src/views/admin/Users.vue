...
const fetchUsers = async () => {
  try {
    const res = await fetch('http://https://mochi-mevn.onrender.com/api/admin/users', {
      credentials: 'include'
    })
...
const updateRole = async (user) => {
  ...
  try {
    const res = await fetch(`http://https://mochi-mevn.onrender.com/api/admin/users/${user._id}/role`, {
      method: 'PUT',
...
const confirmDelete = async () => {
  try {
    const res = await fetch(`http://https://mochi-mevn.onrender.com/api/admin/users/${userToDelete.value._id}`, {
      method: 'DELETE',
      credentials: 'include'
    })
    const data = await res.json()
