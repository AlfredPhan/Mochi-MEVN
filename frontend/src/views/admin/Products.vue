...
const fetchProducts = async () => {
  try {
    const res = await fetch('http://https://mochi-mevn.onrender.com/api/admin/products', { credentials: 'include' })
...
const saveProduct = async () => {
  try {
    const url = editingProduct.value
      ? `http://https://mochi-mevn.onrender.com/api/admin/products/${editingProduct.value._id}`
      : 'http://https://mochi-mevn.onrender.com/api/admin/products'
...
const confirmDelete = async () => {
  try {
    const res = await fetch(`http://https://mochi-mevn.onrender.com/api/admin/products/${productToDelete.value._id}`, {
      method: 'DELETE',
      credentials: 'include'
    })
    const data = await res.json()
