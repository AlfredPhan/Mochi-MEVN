...
const fetchReviews = async () => {
    const res = await fetch(`http://https://mochi-mevn.onrender.com/api/reviews/${route.params.id}`)
...
const submitReview = async () => {
    ...
    try {
        const res = await fetch('http://https://mochi-mevn.onrender.com/api/reviews', {
            method: 'POST',
            headers: {
...
const fetchProduct = async () => {
    const res = await fetch(`http://https://mochi-mevn.onrender.com/api/products/${route.params.id}`)
    const data = await res.json()
    product.value = data
}
